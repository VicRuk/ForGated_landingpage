            ...
            <div class="container">
                <div class="row justify-content-center align-items-center py-3">
                    <div class="col-12 col-md-2 mb-2 text-center d-flex justify-content-center align-items-center">
                        <a class="text-decoration-none" href="../index.php#"><img src="files/img/logo.png" class="img-fluid col-2 col-sm-1 col-md-5 col-lg-4" style="filter: invert(100%);"></a>
                    </div>
                    ...
                    <div class="col-12 col-md-2 mb-2 text-center d-flex justify-content-center align-items-center">
                        <a class="text-decoration-none" href="index.php#sobre" style="color: #000" id="items-footer">SOBRE</a>
                    </div>

                    <div class="col-12 col-md-2 mb-2 text-center d-flex justify-content-center align-items-center">
                        <a class="text-decoration-none" href="index.php#projeto" style="color: #000" id="items-footer">PROJETO</a>
                    </div>

                    <div class="col-12 col-md-2 mb-2 text-center d-flex justify-content-center align-items-center">
                        <a class="text-decoration-none" href="noticias.php" style="color: #000" id="items-footer">NOTÍCIAS</a>
                    </div>
